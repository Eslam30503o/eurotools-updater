...
CATEGORIES = ["الكل", "BOM", "CNC Cutting Tools", "Hand Tools", 
              "Machine Spare Parts", "Oil & Lubricants", 
...
class EditToolMixin:
    ...
    def _open_edit_tool_window(self, tool_name_en_to_edit):
        ...
        name_en_entry = ctk.CTkEntry(
            names_frame, 
            font=("Arial", 12),
            height=40,
            corner_radius=8
        )
        name_en_entry.insert(0, selected_tool_data.get("name_en", tool_name_en_to_edit))
        name_en_entry.pack(fill="x", padx=15, pady=(0, 10))
        ...
        name_ar_entry = ctk.CTkEntry(
            names_frame, 
            font=("Arial", 12),
            height=40,
            corner_radius=8
        )
        name_ar_entry.insert(0, selected_tool_data.get("name_ar", ""))
        name_ar_entry.pack(fill="x", padx=15, pady=(0, 15))
        ...
        template_entry.insert(0, selected_tool_data.get("template", ""))
        template_entry.pack(fill="x", padx=15, pady=(0, 15))
        ...
        def add_prop_field(name="", value="", is_existing=False):
            ...
            if is_existing:
                ...
                delete_btn = ctk.CTkButton(
                    ...
                    width=38,
                    height=38,
                    command=lambda: [new_props_fields.pop(name_entry, None), prop_frame.destroy()],
                    fg_color="#e74c3c", 
                    hover_color="#c0392b",
                    corner_radius=6,
                    font=("Arial", 14, "bold")
        ...
        ctk.CTkButton(
            ...
            command=lambda: add_prop_field("", "", False),
            height=38,
            font=("Arial", 12, "bold"),
        ...
        def save_changes():
            ...
            new_name_en = name_en_entry.get().strip()
            if not new_name_en:
            ...
            updated_tool_data = {
                "name_en": new_name_en,
                "name_ar": name_ar_entry.get().strip(),
